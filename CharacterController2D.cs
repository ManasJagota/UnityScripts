...
public class CharacterController2D : MonoBehaviour {
	...
	void Update()
	{
		...
		else if(_canDoubleJump && CrossPlatformInputManager.GetButtonDown("Jump"))    //If candoublejump and jump pressed, then double jump
        {
			DoJump();
			//disable double jump after doing it once
